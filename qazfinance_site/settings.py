"""
Django settings for qazfinance_site project.
"""
...
ROOT_URLCONF = 'qazfinance_site.urls'
...
WSGI_APPLICATION = 'qazfinance_site.wsgi.application'


# Database
# https://docs.djangoproject.com/en/5.0/ref/settings/#databases

# Use DATABASE_URL from environment if available (Railway/PostgreSQL), otherwise use SQLite
...
DATABASES = {
    'default': dj_database_url.config(
        ...
        ssl_require=bool(os.getenv('DATABASE_URL')),  # Require SSL only for production PostgreSQL
    )
}
